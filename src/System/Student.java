...
public class Student {
	...
	void input() {
		System.out.print("Enter Name:");name=kb.nextLine();
		System.out.print("Enter Age:");age=kb.nextInt();
		System.out.print("Enter StudentId:");studentId=kb.nextLine();
		System.out.print("Enter Major:");major=kb.nextLine();
		System.out.print("Enter Gpa:");gpa=kb.nextDouble();
	}
    void output() {
